...
import swc_logo from "../assets/Images/swc-logo.jpg";
...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#01154a] py-6 px-4 md:px-20 flex flex-wrap items-center justify-center md:justify-start text-white space-y-0">
        <img src={swc_logo} alt="SWC Logo" className="h-6 object-cover" />
        <p className="ml-2 md:ml-4 font-normal">
          {new Date().getFullYear()} @Students'-Web-Committee
        </p>
      </div>
    </>
  );
