...
const About = () => {
    return (
        <div className="md:col-span-2 space-y-5">
            <h1 className="text-2xl font-semibold text-gray-800 mb-7 leading-snug">
                Welcome to<br />The Student’s Affair
            </h1>
            <div className="space-y-4 text-justify text-gray-700 text-[17px] leading-relaxed">
                <p>
